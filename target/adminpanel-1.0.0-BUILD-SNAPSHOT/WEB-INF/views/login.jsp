...
<html>
 ...
 <body class="login-page">
        ...
        <div class="login-wrapper">
            <!-- BEGIN Login Form -->
            <form id="form-login" modelAttribute="login"  action="loginProcess" method="post">
                <h3>Login to your account</h3>
                <hr/>
                <div class="form-group">
                    <div class="controls">
                        <input type="text" placeholder="Username" class="	form-control" path="username" name="username" id="username" />
                        
                    </div>
                </div>
                <div class="form-group">
                    <div class="controls">
                        <input type="password" placeholder="Password" class="form-control" path="userpassword" name="userpassword" id="userpassword" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="controls">
