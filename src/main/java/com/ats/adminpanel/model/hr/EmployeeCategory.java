...
private int empCatId ;
	...
	public EmployeeCategory(int empCatId, int companyId, String empCatName, String empCatShortName,
			String empCatRemarks, int delStatus, int isActive, int makerUserId, String makerEnterDatetime) {
		super();
