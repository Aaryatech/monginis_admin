...
public class TaskDetailDisplay {
	...
	public String toString() {
		return "TaskDetailDisplay [taskId=" + taskId + ", dutyId=" + dutyId + ", taskNameEng=" + taskNameEng
				+ ", taskNameMar=" + taskNameMar + ", taskNameHin=" + taskNameHin + ", taskDescEng=" + taskDescEng
				+ ", taskDescMar=" + taskDescMar + ", taskDescHin=" + taskDescHin + ", photoReq=" + photoReq
				+ ", remarkReq=" + remarkReq + ", taskWeight=" + taskWeight + ", createdBy=" + createdBy
				+ ", createdDate=" + createdDate + ", delStatus=" + delStatus + ", exInt1=" + exInt1 + ", exInt2="
				+ exInt2 + ", exInt3=" + exInt3 + ", exVar1=" + exVar1 + ", exVar2=" + exVar2 + ", exVar3=" + exVar3
				+ ", dutyName=" + dutyName + ", createdByName=" + createdByName + "]";
	}
