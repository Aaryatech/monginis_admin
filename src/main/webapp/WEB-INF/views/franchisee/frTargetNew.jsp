...
<body onload="chkRequest(${isSave})">
	...
	<c:url var="searchFrMonthTarget" value="/searchFrMonthTargetNew" />
				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							...
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/showAddFrTarget"></a>
						...
						<form
							action="${pageContext.request.contextPath}/addFrTargetProcessNew"
							...
							<div class="box-content">
								...
								<div class="col2">
									<label class="col-sm-1 col-lg-2 control-label">Select
										Year</label> <input class="date-own form-control"
										style="width: 200px;" type="text" name="year" id="year"
										placeholder="select Year" value="${thisYear}">
								...
								<div class="col2">
									<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-5">
										<input type="button" class="btn btn-primary" value="Search"
											onclick="searchFrMonthTarget();validation()">
								...
								<div class="box">
									...
									<div class="box-content">
										...
										<label for="search" class="col-md-3" id="search"> <i
											...
											placeholder="Search Month.." title="Type in a name">
										</label>
												...
												<table id="table2" class="main-table">
													<thead>
														<tr class="bgpink">
															...
															<th width="95" align="left">Month</th>
															<th width="95" align="left">Target</th>
															<th width="95" align="left">GRN/GVN Target</th>
															<th width="95" align="left">School Visit Target</th>
															<th width="95" align="left">Actual School Visit</th>
														...
														<c:forEach items="${months}" var="months"
															...
															<tr>
																...
																<td align="left"><input type="text"
																	class="form-control" name="month${count.index+1}"
																	id="month${count.index+1}" maxlength="12" size="12"
																	value="${months}" readonly /></td>
																<td align="left"><input type="text"
																	class="form-control" name="target${count.index+1}"
																	id="target${count.index+1}" maxlength="14" size="14"
																	value="0" data-rule-number="true"
																	data-rule-required="true" /></td>
																<td align="left"><input type="text"
																	class="form-control"
																	name="grngvn_target${count.index+1}"
																	id="grngvn_target${count.index+1}" maxlength="14"
																	size="14" value="0" /></td>
																<td align="left"><input type="text"
																	class="form-control"
																	name="school_target${count.index+1}"
																	id="school_target${count.index+1}" value="0" /></td>
																<td align="left"><input type="text"
																	class="form-control" name="sch_act${count.index+1}"
																	id="sch_act${count.index+1}" value="0" /></td>
									...
									<div class="form-group">
										<div
											...
											<input type="submit" class="btn btn-primary" value="Submit"
												onclick="return validation()" id="targetSave">
											<!-- 										<button type="button" class="btn">Cancel</button>
 -->
										</div>
									</div>
				...
				$.getJSON('${searchFrMonthTarget}', {
					...
					$.each(data,function(key, frTarget) { 
					 ...
					 //	document.getElementById('target'+frTarget.frTargetMonth).disabled = true; 
						document.getElementById('grngvn_target'+frTarget.frTargetMonth).value = frTarget.frAchievedSale;
						//document.getElementById('ach_target'+frTarget.frTargetMonth).disabled = true;
						document.getElementById('school_target'+frTarget.frTargetMonth).value = frTarget.frAward;
