...
<body>
<c:forEach items="${resBean.ggHeaderList}" var="gHead" varStatus="count1">
...
<c:set var="headVar" value="${gHead.grnGvnHeaderId}"></c:set>
														...
														<c:otherwise>
															<c:choose>
																...
																<c:when test="${detail.grnType==1}">
																	...
																	<c:set var="rate" value="${(detail.baseRate-(detail.baseRate*(detail.itemMrp/100)))* 0.65}"></c:set>
			...
			<tr>
				...
				<td
					...
					<td
					style="border-top: 1px solid #E7E7E7; padding: 20px 7px 2px 0px;">Galdhar Foods 
					            Phone: 0240-2466217</span>
				</td>
