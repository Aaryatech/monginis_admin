...
<body>
  	<c:forEach items="${billDetails}" var="frDetails" varStatus="count">
						<h6 align="center">TAX INVOICE</h6><div style="text-align: right; font-size: 10px;" >CIN - U15122MH2011PTC221108</div>
...
Phone:0240-2466217, Email: aurangabad@monginis.net</p>
    ...
    <td colspan="3" width="20%" style="border-left:1px solid #313131; padding:10px;color:#FFF; font-size:15px;">
   	<p style="color:#000; font-size:11px; text-align:left;margin:0px;"> Original for Buyer <br />
Duplicate for Transporter<br/>Triplicate for Assesse</p> 
    </td>
...
<!--         <p style="color:#000; font-size:13px; text-align:left;margin:0px;"></p>
 ...
 <td align="center" width="5%" rowspan="2" style=" border-bottom:1px solid #313131; border-left:1px solid #313131; padding:10px;color:#000; font-size:10px;">Qty</td>
  ...
  <c:set var = "totalQty" value = "0"/>
   ...
   <tr>
       <td  style="border-left:1px solid #313131; padding:3px 5px;color:white; font-size:10px;">-</td>
   
    <td  style="border-left:1px solid #313131; padding:3px 5px;color:#000; font-size:10px;"><u><b>${category.catName}</b></u></td>
        <td  style="border-left:1px solid #313131; padding:3px 5px;color:white; font-size:10px;">-</td>
        <td  style="border-left:1px solid #313131; padding:3px 5px;color:white; font-size:10px;">-</td>
        <td  style="border-left:1px solid #313131; padding:3px 5px;color:white; font-size:10px;">-</td>
        <td  style="border-left:1px solid #313131; padding:3px 5px;color:white; font-size:10px;">-</td>
  ...
  <tr>
   ...
   double fAmt=(Double) pageContext.getAttribute("finalAmt");
   ...
   %>
    ...
    <td align="right" style="border-left:1px solid #313131;border-bottom:1px solid #313131; padding:4px;color:#000; font-size:12px;"><b><%-- <fmt:formatNumber type="number"
								 value="${totalAmt+totalCgst+totalSgst}"/> --%><%=fAmt%></b></td>
  </tr>
</table>
...
<c:when test="${slabwiseBills.billNo==frDetails.billNo}">
  ...
  <tr>
    <td colspan="6" width="50%" style="border-left:1px solid #313131; padding:8px;color:#000; font-size:12px;">
     <p style="color:#000; font-size:12px; text-align:left;margin:0px;">FDA Declaration: We hereby certify that food mentioned in the Tax Invoice is warranted to be of
the nature and quality which it purpose to be. FDA Lic. No: 11515044000208</p>
</td>
    <td colspan="5" width="38%" rowspan="2" style="border-left:1px solid #313131; padding:8px;color:#000;font-size:15px;">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="6" width="50%"  style="border-top:1px solid #313131;border-left:1px solid #313131; padding:8px;color:#000; font-size:12px;"><p>Certified that the particulars given above are true and correct.</p>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="6" width="50%"  style="border-top:1px solid #313131;border-left:1px solid #313131; padding:8px;color:#000; font-size:12px;"><p><b>Invoice Value in Rs.</b><br></br> ${frDetails.amtInWords}</p>&nbsp;
</td>
