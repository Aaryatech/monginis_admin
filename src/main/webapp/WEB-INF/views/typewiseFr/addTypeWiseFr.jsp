	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Add Franchisee to Type
					</h1>
				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							...
							<div class="box-tool">
										<a href="${pageContext.request.contextPath}/typeWiseFrList">Back
						...
						<div class="box-content">
							...
							<form action="${pageContext.request.contextPath}/addTypwWiseFr"
									...
									<div class="col2">
										...
										<div class="col-sm-9 col-lg-10 controls">
											...
											<select data-placeholder="Choose Franchisee"
												...
												id="selectedFr" name="selectedFr" data-rule-required="true">
