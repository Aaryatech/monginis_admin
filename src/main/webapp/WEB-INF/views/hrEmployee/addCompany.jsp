				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							...
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/showAddCompany"></a>
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/addCompany"
								...
								<div>
									<input type="hidden" name="prevLogo" value="${cmp.companyLogo}">
								</div>
										...
										<div class="fileupload fileupload-new"
											...
											<div>
												<span class="btn btn-default btn-file"><span
													...
													class="file-input" name="logo" id="logo" /></span> <a href="#"
												...
												<tbody>
													<c:forEach items="${companyList}" var="companyList"
														...
														<tr>
															...
															<td align="left"><img
																src="${url}${companyList.companyLogo}" width="120"
																height="100" /></td>
															...
															<td align="left"><a
																href="${pageContext.request.contextPath}/updateCompany/${companyList.companyId}"><span
																	class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp; <a
																href="${pageContext.request.contextPath}/deleteCompany/${companyList.companyId}"
