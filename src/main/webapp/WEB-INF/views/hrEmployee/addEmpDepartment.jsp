				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							...
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/showAddHrEmpDept"></a> <a data-action="collapse" href="#"><i
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/addHrEmpDept" class="form-horizontal"
								method="post" id="validation-form">

                      <input type="hidden" name="dept_id" id="dept_id" value="${dept.empDeptId}"/>
                     		 ...
                     		 <div class="form-group">
								...
								<div class="col2">
									<label class="col-sm-3 col-lg-2 control-label">Department Name
										</label>
									<div class="col-sm-3 col-lg-4 controls">
							 ...
							 <div class="col2">
									...
									<div class="col-sm-3 col-lg-4 controls">
										<input type="text" name="dept_short_name" id="dept_short_name"
											placeholder="Short Name" class="form-control"
											data-rule-required="true" value="${dept.empDeptShortName}"/>
									</div>
								</div>
												...
												<tbody>
													  <c:forEach items="${deptList}" var="deptList" varStatus="count">
														<tr>
															...
															<td align="left"><a href="${pageContext.request.contextPath}/updateHrDept/${deptList.empDeptId}"><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                                                        
                                                        <a href="${pageContext.request.contextPath}/deleteHrDept/${deptList.empDeptId}"
