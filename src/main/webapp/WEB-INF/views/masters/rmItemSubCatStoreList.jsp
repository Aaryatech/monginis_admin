		...
		<div id="main-content">
			...
			<c:forEach items="${sessionScope.newModuleList}" var="modules">
				<c:forEach items="${modules.subModuleJsonList}" var="subModule">
					...
					<c:choose>
						<c:when test="${subModule.subModuleMapping eq 'showItemSubCatList'}">
							  ...
							  <%int c=1; %>
										<c:forEach items="${rmItemSubCatList}" var="rmItemSubCatList">
											...
											<c:out
												...
												<c:otherwise>
													<a
													href="${pageContext.request.contextPath}/updateRmSubCategory/${rmItemSubCatList.subCatId}" class="disableClick"><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
