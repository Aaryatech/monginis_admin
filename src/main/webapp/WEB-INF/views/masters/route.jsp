			...
			<!-- END Page Title -->
					...
					<c:forEach items="${sessionScope.newModuleList}" var="modules">
						<c:forEach items="${modules.subModuleJsonList}" var="subModule">
							...
							<c:choose>
								<c:when test="${subModule.subModuleMapping eq 'addroute'}">
						...
						<div class="box-content">
							<form action="addRouteProcess" class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-sm-9 col-lg-10 controls">
										<input type="text" name="route_seq_no" id="route_seq_no"
												...
												<tbody>
													<c:forEach items="${routeList}" var="routeList" varStatus="count">
														<tr>
															...
															<c:otherwise>
															<a
																href="${pageContext.request.contextPath}/updateRoute/${routeList.routeId }" class="disableClick"><span
																	class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
															</c:otherwise>
															</c:choose>
															<c:choose>
