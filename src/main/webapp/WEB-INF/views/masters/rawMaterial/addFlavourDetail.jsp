...
<c:url var="getRawMaterialList1" value="/getRawMaterialList1" />
<c:url var="getBaseQty" value="/getBaseQty" />
<c:url var="insertFlavourDetail" value="/insertFlavourDetail"/>
<c:url var="deleteFlavourDetail" value="/deleteFlavourDetail"/>
<c:url var="editFlavourDetail" value="/editFlavourDetail"/>
<c:url var="editFlavour" value="/editFlavour"/>
	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Flavours Detail
					</h1>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i><span>Add Flavour Detail</span>
							</h3>
							<div class="box-tool">
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/addItemDetails" method="post" class="form-horizontal" id=
								...
								<div class="form-group">
									<label class="col-sm-2 col-lg-2 control-label">Flavour Name</label>
									<div class="col-sm-9 col-lg-4 controls">
									
								  <input type="text" name="flavour_name" id="flavour_name" class="form-control" placeholder="Flavour Name" value="${flavour.spfName}" disabled data-rule-required="true"/>
								  <input type="hidden" name="flavour_id" id="flavour_id" class="form-control"  value="${flavour.spfId}" />
							...
							<c:choose>
				              ...
				              <div class="col-sm-2 col-lg-2 control-label" >RM Category</div>
				                ...
				                <label class="col-sm-3 col-lg-2 control-label">No. Of Pieces Per Item</label>
								 	<div class="col-sm-6 col-lg-2 controls">
						     	    <input type="text" name="base_qty" id="base_qty" class="form-control"placeholder="No. Of Pieces Per Item"    data-rule-required="true"/>
								...
								<div class="form-group">
									<label  class="col-sm-2 col-lg-2 control-label">Sequence No</label>
					      	    <div  class="col-sm-2 col-lg-2 control-label">
							    <input type="text" name="sequence_no" id="sequence_no" class="form-control"placeholder="Sequence No." required/>
					     	    </div>
									</div>
					...
					<form action="${pageContext.request.contextPath}/addFlavourDetail" method="post" class="form-horizontal" id=
									"validation-form"
										 method="post">
						<div class="box">
									<!-- <div class="box-title">
										...
										<!-- <div class="table-responsive" style="border: 0">
											<table width="100%" class="table table-advance" id="table1">
												<thead>
												 ...
												 <tbody>
													 <c:forEach items="${flavourDetailList}" var="itemDetailList" varStatus="count">
														<tr>
														<c:choose>
															...
															<td align="left"><c:out
																	value="${itemDetailList.flavourName}"></c:out></td>
															<c:choose>
															...
															<td align="left"><c:out
																...
																<td align="left"><c:out
																	value="${itemDetailList.noPiecesPerFlavour}"></c:out></td>	
															<td align="left"><a href='#' class='action_btn' onclick="editFlavourDetail(${count.index})"> <abbr title='edit'> <i class='fa fa-edit  fa-lg' ></i></abbr> </a>

		                                                    <a href='#' class='action_btn'onclick="deleteFlavourDetail(${count.index});"><abbr title='Delete'><i class='fa fa-trash-o fa-lg'></i></abbr></a>	</td>
...
$(document).ready(function() {
	...
	if (isValid) {
 	...
 	var itemId = $("#flavour_id").val();
	//alert(itemId);
	var itemName=$('#flavour_name').val();
	//alert(selectedValue);
		...
		$.getJSON('${editFlavour}', {
	      ...
	      if(item.delStatus==0)
		  {
			var tr = $('<tr></tr>');
		  	...
		  	tr.append($('<td></td>').html(item.flavourName));
 ...
 */		  	
		  	...
		  	tr.append($('<td></td>').html(item.noPiecesPerFlavour));
		  	
		 	tr.append($('<td></td>').html("<a href='#' class='action_btn' onclick=editFlavourDetail("+key+")> <abbr title='edit'> <i class='fa fa-edit  fa-lg' ></i></abbr> </a> <a href='#' class='action_btn'onclick=deleteFlavourDetail("+key+ ")><abbr title='Delete'><i class='fa fa-trash-o  fa-lg'></i></abbr></a>"));
...
//	alert(rmId+" "+);
	$.getJSON('${insertFlavourDetail}', {
		...
		//alert("Flavour:"+JSON.stringify(data));
		 //$('#loader').hide();
		var len = data.length;
	 ...
	 document.getElementById("sequence_no").value="0";
...
function editFlavourDetail(token){
 
	editFlag=true;
	$.getJSON('${editFlavourDetail}', {
...
<script type="text/javascript">
function deleteFlavourDetail(key){
	var isDel=confirm('Are you sure want to delete this record');
	if(isDel==true)
	{
	$.getJSON('${deleteFlavourDetail}', {
