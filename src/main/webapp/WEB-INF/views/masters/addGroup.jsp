	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i> Group Ledger
					</h1>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Add Group
							</h3>
							<div class="box-tool">
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/addGroupProcess" class="form-horizontal"
								id="validation-form" method="post">

							<input type="hidden" name="miniCatId" id="miniCatId" value="${subCategory2.miniCatId}"/>

								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label">Group
										Name</label>
									<div class="col-sm-9 col-lg-10 controls">
										<input type="text" name="group_name" id="group_name" value="${subCategory2.miniCatName}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9 col-lg-10 controls">
										<input type="text" name="seq_no" id="seq_no" value="${subCategory2.subCatId}"
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-table"></i> Group List
					</h3>
					<div class="box-tool">
...
<jsp:include page="/WEB-INF/views/include/tableSearch.jsp"></jsp:include>
							...
							<div class="clearfix"></div>
								...
								<div id="table-scroll" class="table-scroll">
									...
									<th width="348" align="left">Group Name</th>
									<th width="322" align="left">Sequence No.</th>
									...
									<th width="80" align="left">Action</th>
												...
												<tbody>
					<c:forEach items="${miniSubCategory}" var="miniSubCategory" varStatus="count">
									<tr>
										<td><c:out value="${count.index+1}" /></td>
										<td align="left"><c:out value="${miniSubCategory.miniCatName}" /></td>
										<td align="left"><c:out
												value="${miniSubCategory.subCatId}" /></td>

									
										<td align="left"><a
											href="updateMiniSubCategory/${miniSubCategory.miniCatId}"><span
												class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;

											<a href="deleteMiniSubCategory/${miniSubCategory.miniCatId}"
