...
<body>
	...
	<c:url var="getEmpwiseGatepassReport" value="/getEmpwiseGatepassReport"></c:url>
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Employee Gatepass Report
					</h1>
					<h4></h4>
				</div>
			</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>View Employee Gatepass Report
					</h3>
 ...
 -->
						...
						<div class="form-group">
							...
							<div class="col2">
								...
								<div class="col-sm-3 col-lg-4 controls">
									...
									<select data-placeholder="Choose Supervisor"
										class="form-control chosen" multiple="multiple" tabindex="6"
										id="selectEmp" name="selectEmp">
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>Employee Gatepass Report
					</h3>
	...
	<script type="text/javascript">
		...
		function exportToPDF() {
			...
			window.open("${pageContext.request.contextPath}/showEmpGatepassPdf/"
					+ fromDate + '/' + toDate);
