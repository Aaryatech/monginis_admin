...
<body>
	...
	<c:url var="getMatTrackReportData" value="/getMatTrackReportData"></c:url>
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Material Tracking Report
					</h1>
					<h4></h4>
				</div>
			</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>View Material Tracking Report
					</h3>
 ...
 -->
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>Material Tracking Report
					</h3>
	...
	<script type="text/javascript">
		...
		function exportToPDF() {
			...
			window
					.open("${pageContext.request.contextPath}/showMatGatepassByStatusPdf/"
							+ fromDate + '/' + toDate);
