...
<body>
	...
	<c:url var="getMatGatepassReport" value="/getMatGatepassReport"></c:url>
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Material Gatepass Report
					</h1>
					<h4></h4>
				</div>
			</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>View Material Gatepass Report
					</h3>
						...
						<div class="form-group">
							...
							<div class="col2">
								...
								<div class="col-sm-3 col-lg-4 controls">
									...
									<select data-placeholder="Choose Supplier"
										class="form-control chosen" multiple="multiple" tabindex="6"
										id="selectSup" name="selectSup">

										<option value="-1"><c:out value="All" /></option>

										<c:forEach items="${supList}" var="supList"
											varStatus="count">
											<option value="${supList.vendorId}"><c:out
													value="${supList.vendorName}" /></option>
										</c:forEach>
									</select>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>Material Gatepass Report
					</h3>
	...
	<script type="text/javascript">
		function searchReport() {
			...
			if (supId == null) {
				...
				$
						.getJSON(
								'${getMatGatepassReport}',

								{
									sup_id_list : JSON.stringify(supId),
									fromDate : from_date,
									toDate : to_date,
									ajax : 'true'
	...
	<script type="text/javascript">
		...
		function exportToPDF() {
			...
			window.open("${pageContext.request.contextPath}/showMatGatepassPdf/"
					+ fromDate + '/' + toDate);
