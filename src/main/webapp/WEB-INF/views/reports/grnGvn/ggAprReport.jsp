...
<body>
	...
	<c:url var="getGrnGvnAprHistory" value="/getGrnGvnAprHistory"></c:url>
...
<div class="container" id="main-container">
	...
	<div id="main-content">
		...
		<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Grn Gvn Approval Status Report
				</h1>
				<h4></h4>
			</div>
		</div>
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>Grn Gvn Approval History
				</h3>
