				...
				<div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 col-lg-4 controls date_select">
							<select class="form-control chosen" name="sel_month" id="sel_month">
						...
						<label class="col-sm-3 col-lg-2	 control-label">Select Second
							Month</label>
						<div class="col-sm-6 col-lg-4 controls date_select">
							<select class="form-control chosen" name="sel_month_next" id="sel_month_next">
...
function genPdf()
{
	...
	window.open('${pageContext.request.contextPath}/showSalesComparePdfFr/');
