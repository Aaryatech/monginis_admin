...
<body>
	...
	<c:url var="getGrnGvnByDatewise" value="/getSalesReportComparionFr"></c:url>
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Franchisee Sales Comparison Report
					</h1>
					<h4></h4>
				</div>
			</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>View Franchisee Sales Comparison Report
					</h3>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>Franchisee Sales Comparison Report
					</h3>
							...
							<table class="table table-bordered table-striped fill-head "
								...
								<thead>
									...
									<tr>
										...
										<th rowspan="1"></th>
										<th rowspan="1"></th>
										<th colspan="3" style="text-align: center;" id="actualMonth">First
											Month</th>
		...
		function dropdown(monthfield, yearfield) {
			...
			for (var y = 0; y <= 20; y++) {
				for (var m = (monthtext.length - 1); m >= 0; m--, id++) {
					if (m <= thismonth) {
						yearfield.options[id] = new Option(thisyear + "-"
								+ monthtext[m], thisyear + "" + monthtext[m])
					} else {
					}
				}
				thisyear -= 1
			...
			$
					.getJSON(
							...
							function(data) {
								...
								document.getElementById('diff').innerHTML = data.prevMonth
										+ " " + data.currMonth + "  diff";
												...
												function(key, route) {
																		...
																		if (route.routeId == report.routeId) {
																			...
																			tr
																					.append($(
																							'<td style="text-align:right;"></td>')
																							.html(
																									addCommas((report.perMonthSale / 30)
																											.toFixed(2))));
																			tr
																					.append($(
																							'<td style="text-align:right;"></td>')
																							.html(
																									addCommas((report.perMonthSale * 11.11 / 100)
																											.toFixed(2))));
																			tr
																					.append($(
																							'<td style="text-align:right;"></td>')
																							.html(
																									addCommas((report.perMonthSale * 14.9 / 100)
																											.toFixed(2))));
																			tr
																					.append($(
																							'<td style="text-align:right;"></td>')
																							.html(
																									addCommas((report.perMonthSale * 17.6 / 100)
																											.toFixed(2))));
																			$(
																					'#table_grid tbody')
																					.append(
																							tr);
																			prevMonthRouteSale = prevMonthRouteSale
																					+ report.prevMonthSale;
																			currMonthRouteSale = currMonthRouteSale
																					+ report.perMonthSale;
																		}
													...
													tr
															.append($(
																	...
																	.html(
																			addCommas((currMonthRouteSale)
																					.toFixed(2))));
													tr
															.append($(
																	'<td colspan="2" style="text-align:right; color:blue;"></td>')
																	.html(
																			addCommas((prevMonthRouteSale)
																					.toFixed(2))));
													tr
															.append($(
																	'<td colspan="2"></td>')
...
function addCommas(x){
	...
	<script type="text/javascript">
		...
		function genPdf() {
			...
			window
					.open('${pageContext.request.contextPath}/showSalesComparePdfFr/');
