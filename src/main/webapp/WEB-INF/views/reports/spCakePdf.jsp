	...
	<c:forEach items="${spCakeOrder}" var="spCakeOrder" varStatus="count">
		...
		<table width="100%"
			...
			<tr>
				...
				<td width="40%"
					style="border-bottom: 1px solid #000000; padding: 8px; border-left: 1px solid #000000;">${spCakeOrder.date}</td>
			</tr>
			<tr>
				<td width="15%"
				...
				<td
					...
					${spCakeOrder.spEvents} ${spCakeOrder.spEventsName}</td>

			</tr>
			<tr>
				<td
					style="border-bottom: 1px solid #000000; padding: 5px 7px; font-weight: bold;">Weight</td>
				<td
					style="font-size: 14px; border-bottom: 1px solid #000000; border-left: 1px solid #000000; padding: 5px 7px; font-weight: bold;">${spCakeOrder.inputKgFr}
					kg</td>
				<td
					style="font-size: 14px; border-bottom: 1px solid #000000; padding: 5px 7px; border-left: 1px solid #000000; font-weight: bold;">Flavour--
					${spCakeOrder.spfName}</td>
			</tr>
			<tr>
				<td
					style="font-size: 12px; border-bottom: 1px solid #000000; padding: 10px 7px; font-weight: bold;">Special
					Instructions</td>
				<td colspan="2"
					style="font-family: arial; font-size: 16px; border-left: 1px solid #000000; border-bottom: 1px solid #000000; padding: 5px 7px; font-weight: bold;">${spCakeOrder.spInstructions}</td>
			</tr>
			<!--  <tr>
    ...
    <td colspan="2" style=" font-size:18px; border-bottom:1px solid #000000;border-left: 1px solid  #000000; padding:5px 7px;font-weight:bold;" >Happy Birthday Anushka</td>
			...
			<tr>
				<td
					...
					of Delivery</td>
				<td
					style="font-size: 16px; padding: 5px 7px; font-weight: bold; border-left: 1px solid #000000; border-bottom: 1px solid #000000;">${spCakeOrder.spDeliveryDate}</td>
				<td
					style="font-size: 16px; padding: 5px 7px; font-weight: bold; border-left: 1px solid #000000; border-bottom: 1px solid #000000;">Place
					of Delivery-- ${spCakeOrder.spDeliveryPlace}</td>
			</tr>
