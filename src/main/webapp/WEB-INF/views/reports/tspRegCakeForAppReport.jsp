...
<body>
	...
	<c:url var="getSpCakeList" value="/getSpRegCakeListAjax"></c:url>
	<c:url var="excelForFrBill" value="/excelForTspRegCake" />
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i> SP Regular Cake Order-App
					</h1>
					<h4></h4>
				</div>
			</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>SP Regular Cake Order-App
					</h3>
 ...
 -->
						...
						<div class="form-group">
							...
							<div class="col-sm-4 col-lg-4 controls">
								<select data-placeholder="Select " name="seqenceList"
									...
									<option value="1">Production Sequence</option>
									<option value="2">Order Sequence</option>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>SP Regular Cake Order-App
					</h3>
												...
												function(key, report) {
													...
													tr
															.append($(
																	...
																	.html(
																			"<input type='checkbox' name='select_to_print' value="+report.supId+">"));
	...
	<script type="text/javascript">
		function createExel() {
			...
			if (flag == 1) {
				...
				window
						.open("${pageContext.request.contextPath}/excelForTspRegCake/"
								+ txt);
			} else {
				alert("Please select minimum 1 CRN Note ");
			}
