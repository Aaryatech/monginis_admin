...
<body>
	...
	<c:url var="getBillList" value="/getSpCakeWtCountAjax"></c:url>
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i> SP Cake Report
					</h1>
					<h4></h4>
				</div>
			</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>SP Cake Report
					</h3>
 ...
 -->
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>SP Cake Report
					</h3>
