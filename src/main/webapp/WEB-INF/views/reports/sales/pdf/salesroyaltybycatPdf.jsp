...
<p align="center">Royalty Report (Cat/Item wise R5)</p>
		...
		<tbody>
			...
			<c:forEach items="${catList}" var="report" varStatus="count">
				...
				<td><c:out value="${royalty.item_name}" /></td>
					...
					<c:set var="netQty" value="${royalty.tBillQty -(royalty.tGrnQty+royalty.tGvnQty)}"></c:set>
					
					<c:set var="netValue" value="${royalty.tBillTaxableAmt -royalty.tGrnTaxableAmt+royalty.tGvnTaxableAmt}"></c:set>
