...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<c:url var="getSpecialCakeDispatchDtl" value="/getSpecialCakeDispatchDtl"></c:url>
<div class="container" id="main-container">
	...
	<%-- 	<div id="breadcrumbs">
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>View Special Cake Dispatch Report
			...
			<div class="box-content">
				<div class="row">
					...
					<div class="form-group">
						<label class="col-sm-3 col-lg-2	 control-label">Sp Cake Delivery Date</label>
											...
											.each(
													...
													function(key, report) {
														...
														var tr = $('<tr></tr>');
													  	...
													  	tr.append($('<td></td>').html(report.spDeliveryPlace));
