...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<c:url var="getBillList" value="/getTcsFrDatewise"></c:url>
<div class="container" id="main-container">
	...
	<div id="main-content">
		...
		<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>TCS Report
				</h1>
				<h4></h4>
			</div>
		</div>
	...
	<%-- 	<div id="breadcrumbs">
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>View TCS Report
				</h3>
											...
											.each(
													...
													function(key, report) {
														...
														if(report.isSameState==1){
															...
															total=parseFloat((report.taxableAmt)+(report.cgstSum)+(report.sgstSum)+(report.roundOff));
															
														}
														else{
															
															 total=parseFloat(report.taxableAmt+report.igstSum+report.roundOff);
														}
...
function genPdf()
{
   ...
   window.open('${pageContext.request.contextPath}/pdfForReport?url=pdf/showTcsReportByDatePdf/'+from_date+'/'+to_date+'/'+selectedFr);
