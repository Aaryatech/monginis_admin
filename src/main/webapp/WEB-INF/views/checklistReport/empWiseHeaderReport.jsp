...
<body>
	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Employee Checklist Report
					</h1>
					<h4></h4>
				</div>
			</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>View Employee Checklist Report
					</h3>

				</div>

				<input class="form-control" id="empId" name="empId" size="30"
					type="text" value="${empId}" style="display: none;" />
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col2">
								...
								<div class="col-sm-6 col-lg-4 controls date_select">
									<input class="form-control date-picker" id="empName"
										name="empName" size="30" type="text" value="${empName}"
										readonly="readonly" />
								</div>
							...
							<div class="col2">
								...
								<div style="text-align: center;">
									<button class="btn btn-info" onclick="searchReport()"
										style="display: none;">Search Report</button>

									<button class="btn btn-primary" value="PDF" id="ExcelButton"
										onclick="tableToExcel('table_grid', 'name', 'Employee_Checklist_Report.xls')"
										<c:if test="${reportList == null}"><c:out value="disabled='disabled'"/></c:if>>Excel</button>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>Employee Checklist Report
					</h3>
									...
									<c:forEach items="${reportList}" var="report" varStatus="count">
										...
										<tr>
											...
											<td class="col-md-1" align="left"><c:out
													value="${report.actionDate}" /></td>

											<td class="col-md-1" align="left"><c:out
													value="${report.checklistName}" /></td>

											<td class="col-md-1" align="left"><c:out
													value="${report.closedDate}" /></td>

											<td class="col-md-1" align="left"><c:out
													value="${report.closedByName}" /></td>

											<td class="col-md-1" align="left"><c:out
													value="${report.totalDetailTask}" /></td>
											...
											<td class="col-md-1" align="left"><a
												href="${pageContext.request.contextPath}/showEmpChecklistDetailReport/${report.actionHeaderId}"><abbr
	...
	<script type="text/javascript">
		function exportToPDF() {
			...
			window
					.open("${pageContext.request.contextPath}/showEmpChecklistHeaderReportPdf/"
							+ fromDate + '/' + toDate + '/' + empName);
