...
<body>
	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Department Wise Checklist Detail
						Report
					</h1>
					<h4></h4>
				</div>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-bars"></i>View Department Wise Checklist Detail
						Report
					</h3>
			...
			<div class="box">
				<div class="box-title">
					<h3>
						<i class="fa fa-list-alt"></i>Department Wise Checklist Detail
						Report
					</h3>
							...
							<div class="form-group" id="range">
								...
								<div class="col-sm-2  controls">
									...
									<input type="button" id="expPdf" class="btn btn-primary"
										value="EXPORT TO PDF" onclick="exportToPDF();">
								</div>
							</div>
	...
	<script type="text/javascript">
		function exportToPDF() {
			...
			window
					.open("${pageContext.request.contextPath}/showDeptChecklistDetailReportPdf");
