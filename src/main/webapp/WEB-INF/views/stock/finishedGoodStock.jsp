								...
								$
										.each(
												...
												function(key, item) {
													...
													var qty1 = "<td align=center ><input type=text  class=form-control  id= qty1"+ item.id+ " name=qty1"+item.id+"  ></td>"; 
													
													var qty2 = "<td align=center ><input type=text  class=form-control  id= qty2"+ item.id+ " name=qty2"+item.id+"  ></td>";

													var qty3 = "<td align=center ><input type=text  class=form-control  id= qty3"+ item.id+ " name=qty3"+item.id+"  ></td>";
