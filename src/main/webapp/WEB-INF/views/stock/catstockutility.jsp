...
<body>
	<c:url var="findAllMenus" value="/getAllFrByRouteId" />
				...
				<div class="box-content">
							...
							<div class="col-sm-3 col-lg-2">
								...
								<select data-placeholder="Choose Sub-Category"
									...
									<c:forEach items="${subCatList}" var="subcat" varStatus="count">
										<option value="${subcat.subCatId}"><c:out
												value="${subcat.subCatName}" /></option>
									</c:forEach>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6 col-lg-4 controls">
								<select data-placeholder="Select Route"
									class="form-control chosen" name="routeId" id="routeId"
					...
					<div class="row">
						<div class="col-sm-3 col-md-12" style="text-align: center;">
							<br>
							<button class="btn btn-info" onclick="searchCategoryStock()"
												...
												<select data-placeholder="Select Menu" name="menu"
													...
													<optgroup label="All Menus">
														<c:forEach items="${menuList}" var="menu"
															varStatus="count">
															<option value="${menu.menuId}"><c:out
																	value="${menu.menuTitle}" /></option>
														</c:forEach>
													</optgroup>
				...
				$
						.getJSON(
								...
								function(data) {
																		...
																		function(
																			...
																			tr
																					.append($(
																							...
																							.html(
																									"<span id=billQty"+fr.frId+""+subCat.subCatId+">0</span><input type=hidden name=billQtyInp"+fr.frId+""+subCat.subCatId+" id=billQtyInp"+fr.frId+""+subCat.subCatId+"  /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id=stkQty"+fr.frId+""+subCat.subCatId+">0</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='border: 1px dashed #AAA; width: 60px;height: 30px; border: 1px solid #CCC;'><input type='text' value=0   id=orderQty"+fr.frId+""+subCat.subCatId+"  name=orderQty"+fr.frId+""+subCat.subCatId+" style='width:100px;' />"));
																		});
									...
									$
											.each(
													data.categoryWiseOrderDataList,
													function(key, report) {
		...
		function onItemChange(subCatId) {
...

			{
				...
				$.each(data, function(key, report) {
					...
					$("#stkQty" + report.frId + '' + subCatId + "").html(
							(report.billQty - report.grnQty) + "");
					var grpQty = $(
							"#billQtyInp" + report.frId + '' + subCatId + "")
							.val();
					var itemQty = report.billQty - report.grnQty;

					if (itemQty < grpQty) {
						$("#orderQty" + report.frId + '' + subCatId + "").val(
								grpQty);
					} else {
