...
<c:url var="getCurrentStoreStockPoReport" value="/getCurrentStoreStockPoReport" />
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i>Generated PO Of Store Item
							</h3>
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/showStoreStockReport">Back to List</a> <a data-action="collapse" href="#"><i
			...
			//  var selectId=document.getElementById("selectStock").value;
			  ...
			  // if(selectId==1) {
				 //  document.getElementById("div1").style.display="block";
				   ...
				   $('#loader').show();
					$.getJSON('${getCurrentStoreStockPoReport}', {
						grpId:grpId,
						ajax : 'true'
					}, function(data) {
						$('#loader').hide();
								...
								cnt=cnt+1;
								 tr = $('<tr ></tr>');
								   ...
								   */	tr.append($('<td class="col-md-1"></td>').html(stockList.rmMinQty));
									...
									tr.append($('<td class="col-md-1"></td>').html(stockList.poNo));
									tr.append($('<td class="col-md-1"></td>').html(stockList.poQty));
