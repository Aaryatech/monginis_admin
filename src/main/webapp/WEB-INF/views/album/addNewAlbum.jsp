				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							...
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/showMessages">Back
								...
								<div class="form-group">
									...
									<div class="col2">
										<label class="col-sm-3 col-lg-2 control-label"> Select
											Flavour </label>
										<div class="col-sm-9 col-lg-3 controls">
											<select name="flavourId" id="flavourId" class="form-control"
												placeholder="Select Flavour" data-rule-required="true">
												<option value="">Select Flavour</option>
												<c:forEach items="${flavoursList}" var="flavoursList"
													varStatus="count">
													<c:choose>
														<c:when test="${flavoursList.spfId==spList.spfId}">
															<option value="${flavoursList.spfId}" selected><c:out
