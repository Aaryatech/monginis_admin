		...
		<div id="main-content">
			...
			<c:forEach items="${sessionScope.newModuleList}" var="modules">
				<c:forEach items="${modules.subModuleJsonList}" var="subModule">
					...
					<c:choose>
						<c:when test="${subModule.subModuleMapping eq 'showVariantList'}">
 ...
 -->									</div>
					...
					<div class="row">
							...
							<table class="table table-bordered table-striped fill-head "
								...
								<c:set var = "srNo" value="0"/>
									<c:forEach items="${variantList}" var="variantList"
													...
													<span class="glyphicon glyphicon-edit"  onclick="edit(${variantList.variantId})"> </span> 
													</c:when>
													</c:choose>
													<c:choose>
						...
						<span class="glyphicon glyphicon-remove" > </span></a>
													...
													<c:otherwise>
														<a href="${pageContext.request.contextPath}/deleteVariant/${variantList.variantId}" class="disableClick"
