		...
		<div id="main-content">
			...
			<c:forEach items="${sessionScope.newModuleList}" var="modules">
				<c:forEach items="${modules.subModuleJsonList}" var="subModule">
					...
					<c:choose>
						<c:when test="${subModule.subModuleMapping eq 'showMachineList'}">
									...
									<c:forEach items="${machineList}" var="machineList"
													...
													<c:choose>
														<c:when test="${isEdit==1 }">
															<span class="glyphicon glyphicon-edit"  onclick="edit(${machineList.machineId})"> </span> 
														</c:when>
													</c:choose>
													<c:choose>
														...
														<c:otherwise>
															<a href="${pageContext.request.contextPath}/deleteMachine/${machineList.machineId}"  class="disableClick"
