		...
		<div id="main-content">
			...
			<c:forEach items="${sessionScope.newModuleList}" var="modules">
				<c:forEach items="${modules.subModuleJsonList}" var="subModule">
					...
					<c:choose>
						<c:when test="${subModule.subModuleMapping eq 'showSparePartList'}">
 ...
 -->									</div>
					...
					<div class="row">
									...
									<c:forEach items="${sprPartList}" var="sprPartList"
													...
													<c:choose>
														<c:when test="${isEdit==1 }">
															<span class="glyphicon glyphicon-edit"  onclick="edit(${sprPartList.sprId})"> </span> 
														</c:when>
													</c:choose>
													<c:choose>
						...
						<span class="glyphicon glyphicon-remove" > </span></a>
														...
														<c:otherwise>
														<a href="${pageContext.request.contextPath}/deleteSparePart/${sprPartList.sprId}"  class="disableClick"
