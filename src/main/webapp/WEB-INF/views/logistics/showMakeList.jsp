		...
		<div id="main-content">
			...
			<c:forEach items="${sessionScope.newModuleList}" var="modules">
				<c:forEach items="${modules.subModuleJsonList}" var="subModule">
					...
					<c:choose>
						<c:when test="${subModule.subModuleMapping eq 'showMakeList'}">
				...
				<div class="col-md-12">
					...
					<div class="row">
								...
								<c:set var = "srNo" value="0"/>
									<c:forEach items="${makeList}" var="makeList"
													...
													<c:when test="${isEdit==1 }">
														 <span class="glyphicon glyphicon-edit"  onclick="edit(${makeList.makeId})"> </span> 
													</c:when>
													</c:choose>
													<c:choose>
						...
						<span class="glyphicon glyphicon-remove" > </span></a>
													...
													<c:otherwise>
													<a href="${pageContext.request.contextPath}/deleteMake/${makeList.makeId}" class="disableClick" onClick="return confirm('Are you sure want to delete this record');"   >
						<span class="glyphicon glyphicon-remove" > </span></a>
													</c:otherwise>
													</c:choose>
