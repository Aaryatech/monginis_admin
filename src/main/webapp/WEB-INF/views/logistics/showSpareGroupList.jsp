		...
		<div id="main-content">
			...
			<c:forEach items="${sessionScope.newModuleList}" var="modules">
				<c:forEach items="${modules.subModuleJsonList}" var="subModule">
					...
					<c:choose>
						<c:when test="${subModule.subModuleMapping eq 'showSpareGroupList'}">
 ...
 -->									</div>
					...
					<div class="row">
								...
								<c:set var = "srNo" value="0"/>
									<c:forEach items="${sprGroupList}" var="sprGroupList"
													...
													<c:choose>
														...
														<span class="glyphicon glyphicon-edit"  onclick="edit(${sprGroupList.groupId})"> </span> 
														</c:when>
													</c:choose>
													<c:choose>
						...
						<span class="glyphicon glyphicon-remove" > </span></a>
														...
														<c:otherwise>
														<a href="${pageContext.request.contextPath}/deleteSpareGroup/${sprGroupList.groupId}" class="disableClick"
