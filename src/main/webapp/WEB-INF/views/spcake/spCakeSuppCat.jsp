	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Album Special Cake Supplement
					</h1>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Add Album Special Cake Supplement
							</h3>
							<div class="box-tool">
						...
						<div class="box-content">
							<form
								action="${pageContext.request.contextPath}/addSpCakeSupCatProcess"
											...
											<c:forEach items="${spList}" var="spCakeList"
												...
												<c:choose>
													<c:when test="${spCakeList.spId==spCkSupp.spId}">
														<option value="${spCakeList.spId}" selected><c:out
																value="${spCakeList.spCode}-${spCakeList.spName}" /></option>
													</c:when>
													<c:otherwise>
														<option value="${spCakeList.spId}"><c:out
																value="${spCakeList.spCode}-${spCakeList.spName}" /></option>
													</c:otherwise>
												</c:choose>
											</c:forEach>
							...
							<div class="box">
								<div class="box-title">
									<h3>
										<i class="fa fa-table"></i>Album Special Cake Supplement List
									</h3>
									<div class="box-tool">
														...
														<tr>
															...
															<c:choose>
																<c:when test="${isEdit==1}">
																	<td align="left"><a
																		href="${pageContext.request.contextPath}/updateSpSuppCat/${spSuppList.id}"><span
																			class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;</td>
																</c:when>
																<c:otherwise>
																	<td align="left"><a
																		href="${pageContext.request.contextPath}/updateSpSuppCat/${spSuppList.id}"
