						...
						<div class="col-md-12">
							<div class="box">
								<div class="box-title">
									...
									<div class="box-tool">
										<a href="${pageContext.request.contextPath}/showSpecialCake">Back
											to List</a> <a data-action="collapse" href="#"><i
											class="fa fa-chevron-up"></i></a>
									</div>
								</div>
								<div class="box-content">
									<form action="updateSpCakeCatProcess" class="form-horizontal"
										...
										<div class="form-group">
											...
											<div class="col-sm-9 col-lg-10 controls">
												<input type="text" name="spc_name" id="spc_name"
													value="${specialCake.spName}" class="form-control"
										...
										<div class="form-group">
											...
											<div class="col-sm-9 col-lg-10 controls">
												<textarea class="form-control" name="sp_desc" cols=""
													rows="" id="sp_desc" placeholder="Description"
										...
										<div class="form-group">
											<label class="col-sm-3 col-lg-2 control-label">Sp
												Local Rate </label>
											<div class="col-sm-9 col-lg-10 controls">
										...
										<div class="form-group">
											...
											<div class="col-sm-9 col-lg-10 controls">
												<input type="text" name="mrp_rate1" id="mrp_rate1"
													...
													data-rule-number="true" data-rule-required="true"
													value="${specialCake.mrpRate1}" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 col-lg-2 control-label">OutStation
												MRP Rate </label>
											<div class="col-sm-9 col-lg-10 controls">
										...
										<div class="form-group">
											...
											<div class="col-sm-9 col-lg-10 controls">
												<input type="text" name="total_gst_appli"
													id="total_gst_appli" placeholder="Total GST Applicable"
													class="form-control" data-rule-required="true"
											...
											<div class="col-sm-9 col-lg-10 controls">
												...
												<c:choose>
													<c:when test="${strallowPhUp.equals('0')}">
														...
														<label class="radio-inline"> <input type="radio"
															name="allowphupload" id="allowphupload" value="1" /> Yes
														</label>
											...
											<div class="col-sm-9 col-lg-10 controls">
												<c:choose>
													<c:when test="${isSlotUsed.equals('0')}">
														...
														<label class="radio-inline"> <input type="radio"
															name="isSlotUsed" id="isSlotUsed" value="1" /> Yes
														</label>
