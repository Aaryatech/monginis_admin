                      ...
                      <input type="hidden" name="allocation_id" id="allocation_id" value="${cnfStation.allocationId}"/>
								...
								<c:when test="${isEdit==1}">
								 <div class="col2">
									...
									<select name="st_id" id="st_id" class="form-control" placeholder="Select Station" data-rule-required="true" disabled="disabled">
								...
								<div class="form-group">
									...
									<select name="shift_id" id="shift_id" class="form-control" placeholder="Select Shift" data-rule-required="true" disabled="disabled">
