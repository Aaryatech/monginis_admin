			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
                      ...
                      <input type="hidden" name="allocation_id" id="allocation_id" value="${instAllocation.allocationId}"/>
								 ...
								 <div class="form-group">
									...
									<select name="st_id" id="st_id" class="form-control" placeholder="Select Station" data-rule-required="true" >
											...
											<c:forEach items="${spStationList}" var="spStationList">
										    	<c:choose>
													<c:when test="${spStationList.stId==instAllocation.stationId}">
								  ...
								  <div class="form-group">
									...
									<select name="m_id" id="m_id" class="form-control-choosen" placeholder="Select Instruments" data-rule-required="true">
											<option value="-1">Select Instruments</option>
										  	<c:forEach items="${instrumentsList}" var="instrumentsList">
										    	<c:choose>
													<c:when test="${instrumentsList.instrumentId==instAllocation.instrumentId}">
