		...
		<div id="main-content">
			...
			<c:forEach items="${sessionScope.newModuleList}" var="modules">
				<c:forEach items="${modules.subModuleJsonList}" var="subModule">
					...
					<c:choose>
						<c:when test="${subModule.subModuleMapping eq 'showAddEmployee'}">
													  ...
													  <c:forEach items="${employeeList}" var="employeeList" varStatus="count">
														<tr>
															...
															<c:when test="${isEdit==1 }">
																<a href="${pageContext.request.contextPath}/updateEmp/${employeeList.empId}"><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
															</c:when>
															<c:otherwise>
																<a href="${pageContext.request.contextPath}/updateEmp/${employeeList.empId}" class="disableClick"><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
