					...
					<div class="box">
						...
						<div class="box-content">
							...
							<form id="completproduction"
								action="${pageContext.request.contextPath}/insertBmsStock"
								method="post">
								<div class="box-content">

									<div class="col-md-2">Item Type</div>
									<div class="col-md-3">
										<select data-placeholder="Select Item type"
																					...
																					function(
																						...
																						tr
																								.append($(
																										'<td></td>')
																										.html(
																												"<input type='text' class='form-control' onkeypress='return IsNumeric(event);' ondrop='return false;' onpaste='return false;' value="
																														+ itemList.qty
																														+ " name='stockQty"
																														+ itemList.itemId
																														+ "' >"));
