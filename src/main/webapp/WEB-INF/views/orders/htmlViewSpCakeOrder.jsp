	...
	<div class="ui page grid">
		<div class="wide column">
			<div class="ui segment">
				<div class="ui button aligned center teal" id="create_pdf">Download
					PDF</div>
      ...
      <td ><strong></td>
            ...
            <td align="right"><p style="font-size:12px">##FAMT</p></td>
             ...
             -->
							...
							<tr>
								<td colspan="2">
									<table width="100%" border="0" cellspacing="0" cellpadding="7">
										...
										<tr>
											<td width="200"
												style="border-top: 1px solid #E7E7E7; padding: 5px 7px;"><strong>Place
													of Delivery :</strong> ${spCakeOrder.spDeliveryPlace}</td>
										</tr>
							...
							<tr>
								<td colspan="2"
									style="border-top: 1px solid #E7E7E7; padding: 5px 7px;"><p
										style="font-size: 13px; text-align: justify;">While we
										shall take every care to execute your order as per your
										instruction, We shall not be liable for delay/non delivery or
										for variations in the order and decoration due to
										circumstances beyond our control.</p>
									<p style="font-size: 13px; text-align: justify;">Fresh
										cream items should be stored under refrigeration.Please
										present this receipt at the time of delivery. Order once given
										will not be cancelled/reversed at any cost.</p></td>
							</tr>
						</tbody>
					</table>
				</form>
